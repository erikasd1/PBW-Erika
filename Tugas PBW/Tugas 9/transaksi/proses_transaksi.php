...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   try {
       ...
       foreach ($_POST['buku'] as $buku) {
        ...
        $conn->commit();
        header("Location: /TugasPBW/Tugas9/transaksi/transaksi.php?message=" . urlencode("Pesanan berhasil dibuat."));
        exit;
    } catch (Exception $e) {
        $conn->rollback();
        header("Location: /TugasPBW/Tugas9/transaksi/transaksi.php?message=" . urlencode("Gagal membuat pesanan: " . $e->getMessage()));
        exit;
   }
}
?>
